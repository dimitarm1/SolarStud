...
{---------------------------------------------------------------------------)
   ...
   Einstellung werden COM3 und COM4 nicht unterstÅtzt. Default-Adressen
   sind $3e8 und $2e8. Die Parameter von COM1 und COM2 sind korrekt
   eingestellt und sollten normalerweise nicht geÑndert werden.
...
{ Schnittstelle aktivieren
  ...
  FifoTL     : Falls ein 16550 vorhanden ist, kann man hier die Konstanten
               fÅr den Triggerlevel einsetzen (s.o.)}
