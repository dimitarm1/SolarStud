...
begin
    ...
    begin
        ...
        MainForm.GetChipKartiFrame.mMsg.Lines.Add(PrintText);
        MainForm.GetChipKartiFrame.mMsg.SelAttributes.Color := clBlack;
        PrintText := GetMessage('M38') + ' ' + Card.ClientName; //'������:> '
        MainForm.GetChipKartiFrame.mMsg.Lines.Add(PrintText);
        MainForm.GetChipKartiFrame.mMsg.SelAttributes.Color := clRed;
        PrintText := GetMessage('M39') + ' '; // '���� � �����:> '
        ...
        PrintText := GetMessage('M40') + ' ' + Card.StudioName; //'������:> '
        MainForm.GetChipKartiFrame.mMsg.Lines.Add(PrintText);
        MainForm.GetChipKartiFrame.mMsg.SelAttributes.Color := clBlack;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                MainForm.GetChipKartiFrame.Label137.Caption := GetMessage('M84'); //'��� �����!';
...
//                    MainForm.SOLARIUMI.FieldValues['CENA'];
                ...
                MainForm.GetIzborNaPlashtaneFrame.Label72.Caption := MainForm.GetIzborNaPlashtaneFrame.Label72.Caption + '' +
                    Result + GetMessage('29'); //'��.';
            end;
            Exit;
        end
        else
        begin
            MainForm.GetChipKartiFrame.Label137.Caption := GetMessage('M83'); //'���� �����!';
